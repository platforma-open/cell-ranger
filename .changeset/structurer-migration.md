...
Migrate the block onto the block-tools structurer: slim publishable facade, kind package, ts-builder/oxlint/oxfmt toolchain, workflow-tengo 6.12 and tengo-builder 4.1.4.
