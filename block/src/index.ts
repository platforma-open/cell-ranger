...
export type CellRangerBlockContract = BlockContract;
export type CellRangerBlockOutputs  = BlockOutputs;
export type CellRangerBlockData     = BlockData;
export const CellRangerBlockPointer = BlockPointer;
